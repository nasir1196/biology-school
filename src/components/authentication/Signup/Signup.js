                        ...
                        <div className="mt-4">
                            ...
                            <div className="flex flex-col items-start">
                                ...
                                <label htmlFor="phone" className="block text-sm font-medium text-gray-700 undefined">
                                    { errors.phone && <span className='text-red-800'>Phone is required</span> }
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mt-4">
                            ...
                            <div className="flex flex-col items-start">
                                ...
                                <label htmlFor="password_confirmation" className="block text-sm font-medium text-gray-700 undefined">
                                    { errors.password_confirmation && <span className='text-red-800'>Confirm Password is required</span> }
                                </label>
                            </div>
                        </div>
                        <div className="mt-4">
                            <div className="flex items-center mb-4">
                                ...
                                <label htmlFor="others" className='m-2'>
                                    <input
                                        { ...register( "gender" ) }
                                        type="radio"
                                        value="others"
